...
urlpatterns = [
    ...
    # Company-facing auditor selection entry (the selection UI lives in the auditors app).
    path('auditor-selection/', RedirectView.as_view(pattern_name='auditors:list', permanent=False),
